...
std::vector<uint64_t> random_uint_vector_repeate(uint64_t max_value, uint64_t count);

std::vector<uint64_t> random_uint_vector_unique(uint64_t max_value, uint64_t count);
